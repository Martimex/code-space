...
NOTE: This project initially includes lil-gui as a debug tool. In case you don't need it, you might need to remove lil-gui parts in JS file and also omit the installation step for lil-gui
